...
import dev.bahodir.pdpgreen.adapters.Spin_Adapter_Group
...
import dev.bahodir.pdpgreen.databinding.FragmentCoursStudentAddBinding

class CoursAddFragment : Fragment() {

    lateinit var fraging: FragmentCoursStudentAddBinding
    ...
    override fun onCreateView(
        ...
        fraging = FragmentCoursStudentAddBinding.inflate(inflater, container, false)
            ...
            save.setOnClickListener {
                ...
                if (!boolean!! && student.id != -1) {
                    ...
                    if (grouplist.isEmpty()) {
                        Toast.makeText(requireContext(), "Group not included", Toast.LENGTH_SHORT)
                            .show()
                    } else {
                        val surname = lastname.text.toString()
                        val name = name.text.toString()

...
import dev.bahodir.pdpgreen.adapters.ViewPager2Adapter
import dev.bahodir.pdpgreen.R
import dev.bahodir.pdpgreen.classes.Groups
import dev.bahodir.pdpgreen.database.My_DbHelper
import dev.bahodir.pdpgreen.databinding.FragmentGroupItemPagerBinding
import dev.bahodir.pdpgreen.databinding.GroupItemBinding
import dev.bahodir.pdpgreen.databinding.ItemDeletBinding
                ...
                ViewPager2Adapter(
                    ...
                    object : ViewPager2Adapter.OnClickMyListener {
                        ...
                        override fun onClickEdit(mentor: Groups, position: Int) {
                            ...
                            val times =
                                listOf("14:00-16:00", "16:30-18:30", "19:00-21:00")
